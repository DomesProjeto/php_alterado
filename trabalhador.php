            ...
            <form action="#"> <!-- Formulário com método de ação indefinido -->
                ...
                <div class="input-group"> <!-- Div para o grupo de campos de entrada -->
                    <div class="input-box"> <!-- Div para cada caixa de entrada -->
                        ...
                        <input id="cep" type="text" name="cep" placeholder="Digite o CEP" onblur="buscarEndereco()" required> <!-- Campo de entrada para o CEP -->
                    </div>
                    ...
                    <div class="input-box"> <!-- Outra caixa de entrada -->
                        ...
                        <input id="complemento" type="text" name="complemento" placeholder="Complemento" required> <!-- Campo de entrada para número -->
                    </div>
                    <div class="input-box"> <!-- Outra caixa de entrada -->
                ...
                <div class="continue-button" > <!-- Div para botão de continuação -->
                    <button><a href="especializacao.html">Continuar Cadastro</a></button> <!-- Botão com link para página de menu -->
                </div>

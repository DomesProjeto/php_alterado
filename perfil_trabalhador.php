...
<body>
    <header>
      ...
      <nav id="navbar">
        ...
        <a href="menu.php"><img src="img/menu/logo.png" alt="Descrição da imagem" id="nav_logo" ></a> 
    ...
    <div class="wrapper">
        ...
        <div class="user-card">
            ...
            <div class="user-card-img">
              <img src="img/perfilexpositivo/avatar2.png" alt="">
            </div>
            ...
            <div class="user-card-info">
              ...
              <p><span>Sobre mim:</span> Trabalho fora de casa em tempo integral, por isso preciso que o aplicativo me ajude a encontrar pessoas para fazerem tarefas domesticas.</p>
            </div>
        </div>
    </div>
</body>
